...
<title>Wandering Wheels | My Profile</title>
<!--Bootstrap -->
...
{ ?>
<section class="user_profile inner_pages" style="background-color: black;">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="gray-bg field-title" style="background-color:#e35f21">  
      <div class="profile_wrap">
          <h5 style="color:black">General Settings</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group" style="color:white">
              <label class="control-label" style="color:black">Reg Date -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label" style="color:black">Last Update at  -</label>
             <?php echo htmlentities($result->UpdationDate);?>
            </div>
            <?php } ?>
            <div class="form-group">
              <label class="control-label" style="color:black">Full Name</label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black">Phone Number</label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black">Date of Birth&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black">Your Address</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn" style="background-color:black">Save Changes <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
