...
<title>Wandering Wheels | My Testimonials </title>
<!--Bootstrap -->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 style="color:white">My Testimonials </h5>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Active</a>
                  ...
                  <?php } else {?>
               <div class="vehicle_status"> <a href="#" class="btn outline btn-xs" style="background-color:#e35f21">Waiting for approval</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
