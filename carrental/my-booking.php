...
<title>Wandering Wheels | My Booking</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        <div class="profile_wrap">
          <h5 style="color:white">My Bookings </h5>
...
<li>
    <h4 style="color:orange">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <p style="color:white"><b>From </b> <?php echo htmlentities($result->FromDate);?> <b>To </b> <?php echo htmlentities($result->ToDate);?></p>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelled</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs" style="background-color:#e35f21">Not Confirm yet</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
...
<table>
  ...
  <tr>
    <th colspan="4" style="text-align:center; color:white"> Grand Total</th>
    <th></th>
  </tr>
</table>
<hr />
              <?php }}  else { ?>
                <h5 align ="center" style="color: #e35f21">No booking yet</h5>
              <?php } ?>
