...
<label for="leatherseats"> Leather Seats </label>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2" style="margin-top:20px">
													<button class="btn btn-default" type="reset" style="background-color:black; color:#fff">Cancel</button>
													<button class="btn btn-primary" name="submit" type="submit" style="background-color:black; color:#fff">Save changes</button>
												</div>
											</div>
