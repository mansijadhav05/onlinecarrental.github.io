...
<head>
	...
	<title>Wandering Wheels | New Bookings   </title>
...
<div id="print">
								<table border="1"  class="display table table-striped table-bordered " cellspacing="0" width="100%"  >
...
{				?>	
	<h3 style="text-align:center; color:black">#<?php echo htmlentities($result->BookingNumber);?> Booking Details </h3>

		<tr>
											<th colspan="4" style="text-align:center;color:black">User Details</th>
										</tr>
										<tr>
											<th>Booking No.</th>
										...
										<tr>
											<th colspan="4" style="text-align:center;color:black">Booking Details</th>
										</tr>
											<tr>											
											<th>Vehicle Name</th>
...
<?php } ?>
								...
								<form method="post">
	   <input name="Submit2" type="submit" class="txtbox4" value="Print" onClick="return f3();" style="cursor: pointer; background-color:#f8f5f078; color:#000000 ; width:8% ; border-color: #fff;" />
	</form>
