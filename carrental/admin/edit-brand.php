...
<head>
	...
	<title>Wandering Wheels | Admin Update Brand</title>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();" style="margin-top:20px">
...
?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label" style="margin-top:1px">Brand Name</label>
												<div class="col-sm-8">
										...
										<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit" style="background-color:black;color:#fff ;margin-top:5px">Submit</button>
												</div>
											</div>
