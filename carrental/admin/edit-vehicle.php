...
<head>
	...
	<title>Wandering Wheels | Admin Edit Vehicle Info</title>
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">
<h5> Change Image 1</h5></a>
</div>
<div class="col-sm-4">
<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">
<h5>Change Image 2</h5></a>
</div>
<div class="col-sm-4">
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">
<h5>Change Image 4</h5></a>
</div>
<div class="col-sm-4">
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">
<h5>Change Image 5</h5></a>
<?php } ?>
</div>
