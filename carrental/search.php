...
<title>Wandering Wheels | Car Listing</title>
<!--Bootstrap -->
...
<!--Listing-->
<section class="listing-page" style="background-color:black">
  <div class="container">
    <div class="row">
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p style="color:black" class="list-price">₹<?php echo htmlentities($result->PricePerDay);?> Per Day</p>
            <ul>
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn" style="background-color:#e35f21">View Details  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5 style="color:white"><i class="fa fa-filter" aria-hidden="true" style="color:#e35f21"></i> Find Your  Car </h5>
          </div>
...
<option value="CNG">CNG</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"  style="background-color:#e35f21"><i class="fa fa-search" aria-hidden="true"  style="color:#e35f21"></i> Search Car</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5  style="color:white"><i class="fa fa-car" aria-hidden="true"  style="color:#e35f21"></i> Recently Listed Cars</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> 
                  <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
